...
WHERE "id" IN (
  ...
  WHERE "tab_kind" = 'terminal'
);--> statement-breakpoint
DELETE FROM "tab_group_members" WHERE "tab_kind" = 'terminal';--> statement-breakpoint
...
DELETE FROM "terminals";--> statement-breakpoint
ALTER TABLE "terminals" ADD COLUMN "protected_state" jsonb NOT NULL;--> statement-breakpoint
ALTER TABLE "terminals" DROP COLUMN "directory_path";--> statement-breakpoint
ALTER TABLE "terminals" DROP COLUMN "service_command";
