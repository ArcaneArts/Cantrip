...
ALTER TABLE "workers" ADD COLUMN "remote_surface_capabilities" jsonb DEFAULT '{"browser":false,"vnc":false,"transports":["websocket"],"maxSessions":4}'::jsonb NOT NULL;--> statement-breakpoint
