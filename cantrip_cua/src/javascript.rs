...
((host, stringify) => {
  ...
  Object.defineProperty(globalThis, 'cua', { value: Object.freeze({
    ...
    keyChord: (keys, holdMs = 500, modifiers = []) => call({operation:'perform', command:{kind:'timeline',frames:[{atMs:0,keyDown:keys,...(modifiers.length ? {keyModifiers:modifiers} : {})},{atMs:holdMs,keyUp:keys}]}}),
