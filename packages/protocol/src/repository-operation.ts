...
const repositoryOperationAccessByType = {
  ...
  "github.pull-request.agent-context": "read",
  ...
  "github.pull-request.review.mutate": "write",
  ...
  "github.actions.overview": "read",
  "github.actions.run.get": "read",
  "github.actions.run.logs": "read",
  "github.actions.workflow.dispatch": "write",
  "github.actions.run.action": "write",
  "github.actions.run.checkout.prepare": "read",
