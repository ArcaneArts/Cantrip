...
export {
  ...
  projectViewCreateKindSchema,
  projectViewCreateSchema,
  encryptedProjectViewCreateSchema,
  projectTabKindSchema,
  projectBuiltInSurfaceStateSchema,
  projectDockPresentationModeSchema,
  projectDockSplitFractionSchema,
  projectDockPresentationPreferenceSchema,
  projectDockPresentationUpdateSchema,
  projectCenterSplitDirectionSchema,
  projectCenterSplitEdgeSchema,
  projectCenterSplitFractionSchema,
  projectCenterLayoutNodeSchema,
  projectTabMemberSummarySchema,
  projectTabMemberWireSummarySchema,
  projectPaneSummarySchema,
  projectPaneWireSummarySchema,
  ...
  legacyProjectTabMemberSummarySchema,
  legacyProjectTabMemberWireSummarySchema,
  ...
  legacyProjectTabLayoutSummarySchema,
...
export type {
  ...
  LegacyProjectTabMemberSummary,
  LegacyProjectTabMemberWireSummary,
  TabGroupSummary,
  TabGroupWireSummary,
  TabGroupUpdate,
...
export {
  ...
  projectPaneIdFromDestination,
} from "./project-pane-identifiers.js";
export type { ProjectPaneRegion } from "./project-pane-identifiers.js";
