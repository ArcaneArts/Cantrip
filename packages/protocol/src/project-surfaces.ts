...
export const PROJECT_SURFACE_DEFINITIONS = projectSurfaceRegistrySchema.parse([
  ...
  {
    id: "project.github-pull-requests",
    scope: "project",
    cardinality: "multi-instance",
    label: "Pull Requests",
...
> = {
  ...
  "project.git-graph": "view",
  "project.github-issues": "view",
  "project.github-pull-requests": "view",
  "project.github-actions": "view",
};
...
> = {
  ...
  "project.git-graph": "graph",
  "project.github-issues": "issues",
  "project.github-pull-requests": "prs",
  "project.github-actions": "actions",
};
