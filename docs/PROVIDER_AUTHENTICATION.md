...
- Codex boundary: packaged `codex-cli 0.149.0`
...
## ChatGPT through Codex 0.149

Portable ChatGPT requires Codex 0.149.x, experimental API negotiation, and the
...
This interface is experimental in Codex 0.149. Cantrip does not patch it, but a
