...
- Codex boundary: packaged `codex-cli 0.153.4`
...
## ChatGPT through Codex 0.153

Portable ChatGPT requires Codex 0.153.x, experimental API negotiation, and the
...
This interface is experimental in Codex 0.153. Cantrip does not patch it, but a
