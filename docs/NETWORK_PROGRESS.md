...
T2.7B, and the Remote Desktop cutover is implemented and validated in T2.8
pending its PR merge. Worker observations, incremental chat, filesystem watcher
migration, relay consolidation, and the final acceptance gate follow. TURN and
