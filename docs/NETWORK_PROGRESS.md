...
The separately decided native Tauri carrier is next, followed by Browser Remote
Surface, Remote Desktop, worker observations, incremental chat, filesystem
watcher migration, relay consolidation, and the final acceptance gate. Native
desktop tunnels still map LAN/WAN stream labels onto their existing direct
summary state; T2.6 decides and implements the physical native carrier. TURN
