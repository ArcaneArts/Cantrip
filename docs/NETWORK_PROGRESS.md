...
| Mobility and mixed routes | Cellular/Wi-Fi failure injection reprobes in priority order; existing streams retain their route while new channels promote; per-channel failure does not collapse a healthy sibling carrier | Pass                           |
