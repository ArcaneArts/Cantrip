...
| S2 — Route status projection | Expose feature-neutral current-client WorkerLink lifecycle and route snapshots               | Planned  | Pending                                 | Pending                                                  | Pending                                                                                                                              | Must retain bounded last-used state without exposing private addresses or credentials                                                      |
| S3 — Settings Network Map    | Render truthful control-plane and LOCAL/RELAY data-plane state                               | Planned  | Pending                                 | Pending                                                  | Pending                                                                                                                              | Must not infer an active route from worker presence or another account client's server session                                             |
