...
| Task briefs, plans, questions, answers, directions, errors, and Goal objectives  | Plaintext production persistence; versioned opaque contracts and endpoint codecs implemented | Contract foundation complete; persistence planned | Excellent            | Medium-High | Server cannot inspect or transform Task content                                                |
