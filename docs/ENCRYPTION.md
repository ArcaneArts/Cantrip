...
these codecs. Task database columns, planner prompts, results, and secondary
chat copies remain plaintext until the later Task persistence and relay
milestones, so Tasks are not yet marked E2EE complete.
