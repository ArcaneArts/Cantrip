...
function validateConfig(config, configPath) {
  ...
  if (
    ...
    throw new Error(
      `Invalid devtop Tauri identity at ${configPath}; expected productName Cantrip and an isolated art.cantrip.dev.h<uuid> identifier. ` +
...
export async function ensureDevtopTauriConfig({
  ...
  const existing = await readConfig(configPath, readTextFile);
