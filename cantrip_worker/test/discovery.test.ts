...
describe("Codex runtime discovery", () => {
  ...
  it("parses the installed CLI version without depending on its prefix", () => {
    expect(parseCodexSemanticVersion("codex-cli 0.150.1")).toBe("0.150.1");
    expect(parseCodexSemanticVersion("0.150.9")).toBe("0.150.9");
