...
describe("Codex runtime discovery", () => {
  ...
  it("parses the installed CLI version without depending on its prefix", () => {
    expect(parseCodexSemanticVersion("codex-cli 0.151.0")).toBe("0.151.0");
    expect(parseCodexSemanticVersion("0.151.9")).toBe("0.151.9");
